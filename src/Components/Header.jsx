      ...
      <div className="flex items-center space-x-5">
        ...
        <div className="flex items-center space-x-5">
          <button className="relative text-2xl text-gray-600">
            <GoBell size={28} />
            <span className="absolute top-0 right-0 -mt-1 -mr-1 flex justify-center items-center bg-indigo-600 text-white font-semibold text-white font-semibold text-[10px] w-5 h-4 rounded-full ">9</span>
          </button>
          <img
            className ="w-8 h-8 object-fit rounded-full border-4 border-indigo-400"
